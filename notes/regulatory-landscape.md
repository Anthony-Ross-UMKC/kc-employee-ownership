# Regulatory landscape — can the rules be changed?

Research findings, September 9, 2026. **Not independently verified by the team.** Read the
sources before relying on any of it.

Relevant because the course is about policy innovation, and "propose a regulatory carve-out"
is a plausible thing for this project to recommend. Two findings make that harder than it
looks.

## Missouri has nothing, and neither does Kansas

No regulatory sandbox, no alternative business structure authority, no licensed
paraprofessional or legal technician program.

[Mo. R. Prof. Conduct 4-5.4](https://www.courts.mo.gov/courts/ClerkHandbooksP2RulesOnly.nsf/c0c6ffa99df4993f86256ba50057dcb8/f24035f1d363a02d86256ca6005211cd?OpenDocument=)
still tracks the traditional ABA model rule — no fee sharing with nonlawyers, no partnership
with nonlawyers for the practice of law, no nonlawyer ownership. Last substantively amended
2007. Rule 4-5.5 has no carve-out.

Kansas is the same — KRPC 5.4 retains the traditional formulation. **Neither side of the
Kansas City metro line has any regulatory-innovation program.** For a project framed around
the metro, that is worth knowing before proposing anything cross-border.

Missouri is absent from the national trackers
([IAALS](https://iaals.du.edu/projects/unlocking-legal-regulation/regulatory-models),
[Stanford](https://clp.law.stanford.edu/legal-innovation-clearinghouse/)) in **both**
directions — not listed as having adopted anything, and not listed as having considered and
rejected anything. Best characterization: Missouri has not publicly engaged with this reform
wave, rather than having weighed and declined it. *(Treat "never formally considered" as
probable but not established — the researcher could not fully enumerate Missouri Bar
committees because the site blocks automated access. Worth a manual check.)*

## The Missouri obstacle is statutory, not just judicial

This is the finding that matters most, and it distinguishes Missouri from the reform states.

Utah and Arizona both proceeded on the theory that **the judiciary holds exclusive
constitutional authority over the practice of law**, so their supreme courts could authorize
reform by rule or standing order.

Missouri has [RSMo § 484.020](https://revisor.mo.gov/main/OneSection.aspx?section=484.020)
sitting outside the court's rulemaking power: UPL is a misdemeanor, there is a treble-damages
private action, and the prohibition expressly extends to "associations, partnerships, limited
liability companies, and corporations." Missouri reform would likely have to confront or work
around a statute — a materially different posture from a supreme court order.

That is a genuine policy-innovation finding and probably worth developing rather than
treating as an obstacle to route around.

## "Follow the Utah model" is out of date

Utah's sandbox is being **wound down**, not made permanent. On May 15, 2026 the Utah Supreme
Court announced Phase 3, focused on "sunsetting the Sandbox and institutionalizing reform
efforts." Applications closed May 29, 2026; the sandbox sunsets **August 14, 2027**. As of
July 2026 only **6 regulated entities** remain; since reopening in Feb. 2024, 50 applied, 2
were recommended, 35 denied. ([Utah Innovation
Office](https://utahinnovationoffice.org/phase-3-implementation/))

Utah's Rule 5.4 is structurally dependent on the standing order — if it sunsets without a
replacement, the authorizing predicate has nothing to point to.

**Arizona's permanent rule change proved more durable.** It abrogated ER 5.4 outright
(Order [R-20-0034](https://www.azcourts.gov/Portals/0/215/ABS%20Documents/Final%20Order_R-20-0034.pdf),
effective Jan. 1, 2021) and had 114 licensed alternative business structures at the end of
2024, reportedly 151 by January 2026. Structural difference, not just a bigger number:
Arizona changed the rules; Utah ran a pilot with an expiration date.

If this project proposes anything regulatory, **Arizona is the better model to cite and Utah
is the cautionary one.**

## One risk factor worth noting

California enacted AB 931 (signed Oct. 10, 2025, effective Jan. 1, 2026 through Jan. 1, 2030)
